...
export default function LoadingScreen({ onComplete }) {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const singleBallContainer = singleBallRef.current;
      const singleBallShadows = singleBallContainer?.querySelectorAll(".ball-shadow-group");
        ...
        >
          ...
          <div
            style={{
              ...
              top: "14%",
              left: "20%",
              width: "calc(var(--ball-size) * 0.08)",
              height: "calc(var(--ball-size) * 0.08)",
              maxHeight: "8px",
              maxWidth: "8px",
              borderRadius: "50%",
              background: "#ffffff",
      ...
      >
        ...
        >
          <div
            style={{
              display: "grid",
              gridTemplateColumns: "repeat(3, var(--ball-size))",
              gap: "var(--gap)",
              width: "100%",
              height: "100%",
            }}
